...
public class MainActivity extends AppCompatActivity {
    ...
    android.widget.Button myPage_btn, registerPage_btn, searchPage_btn, alarmPage_btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);

        myPage_btn = (android.widget.Button) findViewById(R.id.myPage_btn);
        ...
        registerPage_btn = (android.widget.Button) findViewById(R.id.registerPage_btn);
        ...
        searchPage_btn = (android.widget.Button) findViewById(R.id.searchPage_btn);
        searchPage_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                Intent intentToSearchPage = new Intent(MainActivity.this, MyPageActivity.class);
//                startActivity(intentToSearchPage);
            }
        });

        alarmPage_btn = (android.widget.Button) findViewById(R.id.alarmPage_btn);
